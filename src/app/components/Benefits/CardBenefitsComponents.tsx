...
export function CardBenefitsH1(props: CardBenefitsH1Props) {
  return (
    <h1
      ...
      className="mb-6 max-w-5xl p-2 pt-8 text-center text-4xl font-semibold uppercase text-white sm:text-5xl md:mx-auto"
      {...props}
    />
  )
}
...
export function CardBenefitsGridParagraph(
  ...
  return <p className="mt-2 text-sm text-white text-center" {...props} />
}
...
export function CardBenefitsGridBg(props: CardBenefitsGridBgProps) {
  return (
    <div
      className="rounded-lg bg-transparent backdrop-blur-md shadow-*-md shadow-brand300/30 p-8"
      {...props}
    />
  )
}
