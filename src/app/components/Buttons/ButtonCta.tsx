  ...
  return (
    <div className="z-50 my-4 flex w-full justify-center sm:justify-start">
      <a
        ...
        className="focus:shadow-outline delay-0 inline-flex h-12 w-auto items-center justify-center rounded-full bg-gradient-to-r from-brand100 to-brand300 px-8 font-medium text-white shadow-brandSecondary duration-75 ease-in-out shadow-*-lg shadow-white/30 hover:scale-105 hover:bg-gradient-to-r hover:from-brand100 hover:to-brand200 hover:transition-colors focus:outline-none sm:h-14 md:w-auto"
        {...props}
      />
    </div>
  )
